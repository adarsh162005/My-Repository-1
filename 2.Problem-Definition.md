...
To design  an efficient and affordable sorting machine that can automatically sort materials like paper,metal and plastic with a user friendly which sort the matarials like paper, metal and plastic. and the plastic should be heavy. the sorted metal and plastic should collet and paper may or may not be collected. where the machine should have a feauter of on or off system and it should show the indicate that the machine is started and afetr compliting the process the machine should show the process completed indication. 