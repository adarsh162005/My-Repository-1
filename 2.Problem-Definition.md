...
|18|do you want to collect the sorted scraps?|we need only magnetic metal and and non metals |||yes|
...
## Problem Definition(v1.2)
 ...
 To design a automatics sorting machine which is capable of the sorting the materials like plastic, meatal and papers scrap whose price shouldn't exceed RS.3000 and its wait should be  not more than 4 kg. and the machine should be made of acrylic sheet. and the conveyer belt should be made up of the rubber . the machine should sort the materials at minimum speed of 100g/min and it should be user friendly.
***
...
To design  an efficient and affordable sorting machine that can automatically sort materials like Magnetic metals (Iron,Nickel,Cobalt) and non metals with a user friendly interface , with 

1.Objectives:
* 1.   Electromagnetic Sorting.
* 2.  Separating Metals and Non Metals

2.Constraints:
* 1.   Affordable and Non Portable 
